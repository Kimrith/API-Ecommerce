        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_audit_logs_Auths_UserId",
                        column: x => x.UserId,
                        principalTable: "Auths",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_notifications_Auths_UserId",
                        column: x => x.UserId,
                        principalTable: "Auths",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_coupon_usages_Auths_UserId",
                        column: x => x.UserId,
                        principalTable: "Auths",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    BakongHash = table.Column<string>(type: "nvarchar(255)", maxLength: 255, nullable: true),
                    Md5 = table.Column<string>(type: "nvarchar(64)", maxLength: 64, nullable: true),
                    KhqrString = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    ReceiverAccountId = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: true),
                    SenderAccountId = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_favorites_Auths_UserId",
                        column: x => x.UserId,
                        principalTable: "Auths",
                        principalColumn: "Id");
                    table.ForeignKey(
